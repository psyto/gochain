...
// MarshalJSON is to marshalize a wallet.
...
// TransactionRequest is a type of a transaction request.
...
// Validate checks if data is missing in some fields in a transaction request.
